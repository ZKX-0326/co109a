...
CHIP Mux8Way16 {
    ...
    PARTS:
    // Put your code here:
    Mux4Way16(a=a, b=b, c=c, d=d, sel[0]=sel[0], sel[1]=sel[1], out=x);
    Mux4Way16(a=e, b=f, c=g, d=h, sel[0]=sel[0], sel[1]=sel[1], out=y);
...
CHIP DMux8Way {
    ...
    DMux4Way(in=x, sel[0]=sel[0], sel[1]=sel[1], a=a, b=b, c=c, d=d);
    DMux4Way(in=y, sel[0]=sel[0], sel[1]=sel[1], a=e, b=f, c=g, d=h);
}
```
* picture
